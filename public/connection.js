...
socket.on('room info', (info) => {
  ...
  info.users.forEach((u, i) => {
    if (u.npc) {
      users += '<li><span class="material-symbols-outlined">smart_toy</span>'+u.name + ' (level '+ u.level +')</li>';
    } else {
      users += '<li><span class="material-symbols-outlined">face</span>'+u.name + ' (level '+ u.level +')</li>';
    }
  });
